...
public class Solution {
    ...
    public static String validation() throws Exception {
    ...
    public static int resultForArab()throws Exception{
    ...
    public static void main(String[] args)throws Exception {
      ...
      String arabOrRome= validation();
     removeSpace();
     segmentation();
     if (arabOrRome.equals("arab"))
         System.out.println(resultForArab());
     else
         System.out.println(resultForRome());
    }
